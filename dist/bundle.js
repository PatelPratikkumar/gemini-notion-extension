...
var server = new Server({ name: "notion-sync", version: "2.0.0" }, { capabilities: { tools: {} } });
  ...
  try {
    switch (name) {
      ...
      case "create_page": {
        ...
        const properties = args?.parentDatabaseId ? { Name: { title: [{ text: { content: args?.title } }] }, ...args?.properties || {} } : { title: { title: [{ text: { content: args?.title } }] } };
